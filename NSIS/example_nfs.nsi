...
!define SOURCEDIRECTORY "C:\temp\qt_static\nazfs"
...
DirText "Setup will create subfolder Minh/MFS and install Minh 3D Flight Simulator on Google Map v0.1. To install in a different folder, click Browse button. Click Install to start the installation."
XPStyle on
...
createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\${COMPANYNAME}\${APPNAME}\nfs.exe" "" "$INSTDIR\${COMPANYNAME}\${APPNAME}\topicon_XaE_icon.ico"
